    ...
    protected function addUserFields()
    {
        $this->crud->addFields([
            ...
            [
                ...
                'hint'       => 'Password length must be greater than 6 and contain Letters and special Characters',
                'type'  => 'password',
            ],
            [
            ...
            [
                // 1-n relationship
                'label'     => 'Faculty', // Table column heading
                'type'      => 'select',
                'name'      => 'faculty_id', // the column that contains the ID of that connected entity;
                ...
                'model'     => "App\Models\Faculty", // foreign key model
            ],
            [
