<?php if($crud->hasAccess('bulkDelete') && $crud->get('list.bulkActions')): ?>
	<a href="javascript:void(0)" onclick="bulkDeleteEntries(this)" class="btn btn-sm btn-secondary bulk-button"><i class="la la-trash"></i> <?php echo e(trans('backpack::crud.delete')); ?></a>
<?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/acakw/public_html/booking/vendor/backpack/crud/src/resources/views/crud/buttons/bulk_delete.blade.php ENDPATH**/ ?>