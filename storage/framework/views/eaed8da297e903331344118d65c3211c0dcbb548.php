...
?>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php if(session('locale')=='ar'): ?> rtl <?php else: ?> ltr <?php endif; ?>">
...
</html><?php /**PATH /home/acakw/public_html/booking/resources/views/vendor/backpack/base/layouts/top_left.blade.php ENDPATH**/ ?>