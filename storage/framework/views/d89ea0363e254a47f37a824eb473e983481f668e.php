                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="<?php echo e(route('backpack.auth.login')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control<?php echo e($errors->has($username) ? ' is-invalid' : ''); ?>" name="<?php echo e($username); ?>" value="<?php echo e(old($username) ?? 'admin@example.com'); ?>" id="<?php echo e($username); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" id="password" value="<?php echo e(old('username')?'':'admin'); ?>">
...
<?php echo $__env->make(backpack_view('layouts.plain'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acakw/public_html/booking/resources/views/vendor/backpack/base/auth/login.blade.php ENDPATH**/ ?>